...
const mockGetCareerRecommendations = getCareerRecommendations as jest.MockedFunction<typeof getCareerRecommendations>
...
describe('CareerDashboard', () => {
  ...
  describe('Initial Render', () => {
    it('should show loading state initially', () => {
      ...
      expect(screen.getByText('Loading your career insights...')).toBeInTheDocument()
    ...
    it('should render career stage after loading', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Your Current Career Stage: Early Career')).toBeInTheDocument()
      })
    })
    ...
    it('should render navigation tabs', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/Goals \(\d+\)/)).toBeInTheDocument()
  ...
  describe('Career Paths Tab', () => {
    ...
    it('should show career path details', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Lead frontend development projects and mentor junior developers')).toBeInTheDocument()
  ...
  describe('Goals Tab', () => {
    it('should switch to goals tab when clicked', async () => {
      ...
      await waitFor(() => {
        const goalsTab = screen.getByText(/Goals \(\d+\)/)
  ...
  describe('Progress Tab', () => {
    ...
    it('should display career stage progress', async () => {
      ...
      expect(screen.getByText('You are currently in the Early Career stage')).toBeInTheDocument()
    })
  ...
  describe('Back to Questionnaire', () => {
    it('should show back button when onBackToQuestionnaire is provided', () => {
      const mockBackFunction = jest.fn()
      
      render(
        <CareerDashboard 
          userData={mockUserData} 
          onBackToQuestionnaire={mockBackFunction}
        />
      )
    ...
    it('should call onBackToQuestionnaire when back button is clicked', () => {
      const mockBackFunction = jest.fn()
  ...
  describe('Error Handling', () => {
    it('should display error message when API call fails', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Error Loading Career Data')).toBeInTheDocument()
        expect(screen.getByText('Failed to load career recommendations. Please try again.')).toBeInTheDocument()
      })
    })
    ...
    it('should handle empty career paths gracefully', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Complete your profile to get personalized career recommendations.')).toBeInTheDocument()
      })
    })
  })
