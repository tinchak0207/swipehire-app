...
export const metadata: Metadata = {
  ...
  description:
    'Navigate your career path with our AI Career Assistant. Get personalized advice, explore career transitions, and build a roadmap for your professional growth.',
};
