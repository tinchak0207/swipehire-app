...
const cardDefinitions: ICardDefinition[] = [
    {
        ...
        inputs: [
            ...
            { name: 'requiredExperienceYears', type: 'number', description: 'The minimum years of experience.' },
            { name: 'skillKeywords', type: 'string[]', description: 'Keywords to search for in the resume.' },
            { name: 'enableVideoAnalysis', type: 'boolean', description: 'Whether to enable video analysis.' },
    ...
    },
    {
        ...
        outputs: [
            { name: 'result', type: 'boolean', description: 'The result of the condition.' },
        ],
    },
    {
        cardType: 'SendInvite',
        ...
        inputs: [
            { name: 'template', type: 'string', description: 'The invitation template.' },
        ],
        outputs: [],
    },
];
