...
import { AlarmClock, Bell, BriefcaseIcon, CheckCircle, Clock, Plus } from 'lucide-react';
...
function ReminderCard({ reminder, onComplete, onSnooze, isUpdating }: ReminderCardProps) {
  ...
  const isValidDate = !Number.isNaN(scheduledDate.getTime()) && !Number.isNaN(now.getTime());
    ...
    <div className="container mx-auto space-y-6 p-6">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-2">
          <h1 className="font-bold text-3xl">Follow-up Reminders</h1>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Pending Reminders</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-2xl">{overdueCount}</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-2xl">{reminders?.length || 0}</p>
          ...
          {isLoading ? (
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <h3 className="mb-2 font-semibold">No reminders found</h3>
