...
export class EventService {
  ...
  static async saveEvent(eventId: string, _userId: string): Promise<void> {
  ...
  static async unsaveEvent(eventId: string, _userId: string): Promise<void> {
  ...
  static async registerForEvent(eventId: string, _userId: string): Promise<void> {
