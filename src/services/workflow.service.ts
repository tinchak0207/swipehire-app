import { IWorkflow, WorkflowNode } from '@/contracts/IWorkflow';
...
class WorkflowService {
  ...
  private async executeNode(node: WorkflowNode, nodes: Map<string, WorkflowNode>, edges: Edge[]): Promise<void> {
