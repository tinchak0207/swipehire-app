            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              >
                <div className="card-body p-4 text-center">
                  <div
                    className={`mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-full ${preferences.theme === 'light' ? 'bg-primary-content/20' : 'bg-yellow-100'} `}
                  >
                    <svg
                      className={`h-6 w-6 ${preferences.theme === 'light' ? 'text-primary-content' : 'text-yellow-500'} `}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              >
                <div className="card-body p-4 text-center">
                  <div
                    className={`mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-full ${preferences.theme === 'dark' ? 'bg-primary-content/20' : 'bg-gray-100'} `}
                  >
                    <svg
                      className={`h-6 w-6 ${preferences.theme === 'dark' ? 'text-primary-content' : 'text-gray-700'} `}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              >
                <div className="card-body p-4 text-center">
                  <div
                    className={`mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-full ${preferences.theme === 'system' ? 'bg-primary-content/20' : 'bg-blue-100'} `}
                  >
                    <svg
                      className={`h-6 w-6 ${preferences.theme === 'system' ? 'text-primary-content' : 'text-blue-500'} `}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              <div className="flex items-center justify-between rounded-lg bg-base-100 p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-base-content/60 text-sm">Get urgent updates via text</p>
                  </div>
                </div>
                <input
                  type="checkbox"
              ...
              {[
                ...
                >
                  ...
                  <input
                    ...
                    checked={
                      preferences.notificationSubscriptions?.[
                        item.key as keyof typeof preferences.notificationSubscriptions
                      ] || false
                    }
                    onChange={(e) =>
                      handleNotificationSubscriptionChange(item.key, e.target.checked)
                    }
                  />
                </div>
              ))}
        ...
        <div className="alert alert-info">
          ...
          <div>
            ...
            <div className="text-xs">
              You can change these preferences anytime in your settings. We never share your data
              with third parties.
            </div>
          </div>
        </div>
