...
const FeatureCard = ({ icon, title, description }: { icon: React.ElementType, title: string, description: string }) => {
  const Icon = icon;
  return (
    <Card className="text-center shadow-lg bg-card subtle-card-hover">
...
const TestimonialCard = ({ quote, author, role, avatar }: { quote: string, author: string, role: string, avatar: string }) => (
  <Card className="shadow-lg bg-card subtle-card-hover">
    <CardContent className="pt-6">
      <blockquote className="italic text-muted-foreground leading-relaxed">"{quote}"</blockquote>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-grow">
        <section className="relative py-24 md:py-36 text-white hero-gradient-bg">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-slate-200 max-w-3xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
              ...
              <div className="p-6 space-y-3">
                ...
                <h3 className="text-xl font-semibold text-foreground">Swipe & Discover</h3>
              ...
              <div className="p-6 space-y-3">
                ...
                <h3 className="text-xl font-semibold text-foreground">Connect & Engage</h3>
        ...
        <section id="pricing" className="py-20 md:py-28 bg-muted/50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                    {/* Basic Plan */}
                    <Card className="flex flex-col shadow-lg subtle-card-hover">
                        <CardHeader className="pb-4">
                    ...
                    {/* Pro Plan */}
                    <Card className="flex flex-col shadow-xl border-2 border-primary relative subtle-card-hover">
        ...
        {/* Final CTA Section */}
        <section id="about" className="py-24 md:py-32 hero-gradient-bg-secondary text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight">Ready to Transform Your Hiring or Job Search?</h2>
      ...
      <footer className="py-10 bg-slate-900 text-slate-400">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            <div>
              <h5 className="font-semibold text-slate-200 mb-4 text-lg">SwipeHire</h5>
            ...
            <div>
              <h5 className="font-semibold text-slate-200 mb-4 text-lg">Quick Links</h5>
            ...
            <div>
              <h5 className="font-semibold text-slate-200 mb-4 text-lg">Connect</h5>
      ...
      <style jsx>{`
        /* Gradients defined in globals.css are used via hero-gradient-bg and hero-gradient-bg-secondary */
