...
import { FiFileText, FiChevronDown, FiChevronUp, FiPlus } from 'react-icons/fi';
...
const AnalyzeResumeNode: React.FC<NodeProps<AnalyzeResumeNodeData>> = ({ data, id }) => {
  ...
  const [selectedFields, setSelectedFields] = useState<string[]>(data.analysisFields || ['Skills', 'Work Experience']);
      ...
      <div className="card-body p-4">
        ...
        {expanded && (
          <div className="mt-4 space-y-4">
            <p className="text-sm text-gray-600">Extracts structured data from a resume file. The resume should be provided as input to this node.</p>
