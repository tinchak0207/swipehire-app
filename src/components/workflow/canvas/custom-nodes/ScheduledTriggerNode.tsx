      ...
      <div className="card-body p-4">
        ...
        {expanded && (
          <div className="mt-4 space-y-4">
            <p className="text-sm text-gray-600">Triggers the workflow automatically based on a CRON schedule.</p>
            ...
            <div className="form-control w-full">
              ...
              />
              <label className="label">
                <a href="https://crontab.guru/" target="_blank" rel="noopener noreferrer" className="label-text-alt link link-hover">Need help with CRON syntax?</a>
              </label>
            </div>

            <div className="alert alert-info text-xs mt-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="stroke-current shrink-0 w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
              <span>Example: `0 9 * * 1-5` means "at 9:00 AM every day from Monday to Friday". The output contains the trigger timestamp.</span>
            </div>
          </div>
        )}
      </div>
