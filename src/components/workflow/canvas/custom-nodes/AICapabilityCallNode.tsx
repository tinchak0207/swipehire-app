      ...
      <div className="card-body p-4">
        ...
        {expanded && (
          <div className="mt-4 space-y-4">
            <p className="text-sm text-gray-600">Invokes a specialized AI capability, such as sentiment analysis, keyword extraction, or summarization.</p>
            
            <div className="form-control w-full">
              <label className="label"><span className="label-text font-semibold">AI Capability</span></label>
              <select className="select select-bordered w-full" value={capability} onChange={(e) => setCapability(e.target.value)}>
                <option disabled value="">Select a capability</option>
            ...
            <div className="form-control w-full">
              <label className="label"><span className="label-text font-semibold">Input Data</span></label>
              <textarea 
            ...
            <div className="alert alert-info text-xs mt-2">
              ...
              <span>The output will be the result of the AI capability call, added to the data payload.</span>
            </div>
          </div>
        )}
      </div>
      <Handle type="source" position={Position.Right} id="output" className="w-4 h-4 !bg-cyan-500" />
    </div>
  );
};
