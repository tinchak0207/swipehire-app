...
const SendCommunicationModal: React.FC<SendCommunicationModalProps> = ({ node, onSave, onCancel }) => {
    ...
    <dialog id="send_communication_modal" className="modal modal-open">
      <div className="modal-box">
        ...
        <div className="form-control">
            ...
            <textarea className="textarea textarea-bordered h-24" placeholder="Hi {candidate_name}, ..." value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
        </div>
