...
const RunWorkflowModal: React.FC<RunWorkflowModalProps> = ({ onRun, onCancel }) => {
    const [payload, setPayload] = useState('{ "candidate_name": "John Doe", "resume_text": "Experienced React developer..." }');
    ...
    <dialog id="run_workflow_modal" className="modal modal-open">
      <div className="modal-box">
        ...
        <div className="form-control">
            ...
            <textarea className="textarea textarea-bordered h-48" placeholder='{ "key": "value" }' value={payload} onChange={(e) => setPayload(e.target.value)}></textarea>
        </div>
