    ...
    <form onSubmit={handleSubmit} className="space-y-6 animate-fadeInPage">
      <Alert variant="default" className="bg-blue-50 border-blue-200 text-blue-700">
        ...
        <AlertDescription className="text-blue-700/90">
          Review the AI-generated script below. Feel free to edit it to perfectly match your voice and message. This script will be your guide for recording or for the avatar's text-to-speech.
        </AlertDescription>
      </Alert>

      <div>
        <Label htmlFor="videoScript" className="block text-md font-semibold mb-1">Your Video Resume Script</Label>
        <Textarea
          id="videoScript"
          ...
          required
        />
        <p className="text-xs text-muted-foreground mt-1">Aim for a script that's about 1 minute long when spoken (approx. 150 words).</p>
      </div>
