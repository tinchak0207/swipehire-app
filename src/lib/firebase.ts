...
import { browserLocalPersistence, getAuth, setPersistence } from 'firebase/auth'; // Added setPersistence and browserLocalPersistence
...
const firebaseConfig = {
  ...
  storageBucket:
    process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || 'swipehire-3bscz.firebasestorage.app', // Updated to user-provided value
