...
export default {
  ...
  theme: {
      ...
      backgroundImage: {
        ...
        'purple-gradient-hero': 'linear-gradient(145deg, hsl(260, 70%, 30%), hsl(280, 65%, 45%), hsl(250, 70%, 55%))', // Added for AI HR Assistant page
      },
  		borderRadius: {
  			lg: 'var(--radius)',
        ...
        'gradient-button-hover': { // For the frosted button background
